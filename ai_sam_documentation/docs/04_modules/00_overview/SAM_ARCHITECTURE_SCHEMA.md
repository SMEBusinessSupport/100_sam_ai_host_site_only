# Sam Architecture Schema

**Original file:** `SAM_ARCHITECTURE_SCHEMA.html`
**Type:** HTML
...
<span class="highlight-pink">│                              FRONTEND LAYER                                      │</span>
<span class="highlight-pink">│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐                  │</span>
<span class="highlight-pink">│  │  sam_chat.js    │  │ sam_chat.xml    │  │ sam_chat.scss   │                  │</span>
<span class="highlight-pink">│  │  (OWL Component)│  │ (Templates)     │  │ (Styling)       │                  │</span>
<span class="highlight-pink">│  └────────┬────────┘  └─────────────────┘  └─────────────────┘                  │</span>
<span class="highlight-pink">│           │ EventSource (SSE)                                                   │</span>
<span class="highlight-pink">└───────────┼─────────────────────────────────────────────────────────────────────┘</span>
            │
            ▼
<span class="highlight-blue">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-blue">│                             CONTROLLER LAYER                                     │</span>
<span class="highlight-blue">│  ┌──────────────────────────────────────────────────────────────────────────┐   │</span>
<span class="highlight-blue">│  │  sam_ai_chat_controller.py                                                │   │</span>
<span class="highlight-blue">│  │  ├── /sam/stream_message  (POST) → SSE streaming endpoint                │   │</span>
<span class="highlight-blue">│  │  ├── /sam/permission_response (POST) → Handle access gate responses      │   │</span>
<span class="highlight-blue">│  │  └── /sam/modes/* → Mode management endpoints                            │   │</span>
<span class="highlight-blue">│  └──────────────────────────────────────────────────────────────────────────┘   │</span>
<span class="highlight-blue">└───────────┬─────────────────────────────────────────────────────────────────────┘</span>
            │
            ▼
<span class="highlight-green">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-green">│                              SERVICES LAYER                                      │</span>
<span class="highlight-green">│  ┌─────────────────────┐  ┌─────────────────────┐  ┌─────────────────────┐      │</span>
<span class="highlight-green">│  │  chat_input.py      │  │  node_input.py      │  │  conversation.py    │      │</span>
<span class="highlight-green">│  │  ├ gather_context() │  │  (Workflow nodes)   │  │  (History manager)  │      │</span>
<span class="highlight-green">│  │  └ builds context   │  │                     │  │                     │      │</span>
<span class="highlight-green">│  └──────────┬──────────┘  └─────────────────────┘  └─────────────────────┘      │</span>
<span class="highlight-green">└─────────────┼───────────────────────────────────────────────────────────────────┘</span>
              │
              ▼
<span class="highlight-purple">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-purple">│                               MODELS LAYER                                       │</span>
<span class="highlight-purple">│  ┌───────────────────────────────────────────────────────────────────────────┐  │</span>
<span class="highlight-purple">│  │  ai_brain.py (ai.service) - THE BRAIN                                     │  │</span>
<span class="highlight-purple">│  │  ├── send_message_streaming()     → Main entry point                      │  │</span>
<span class="highlight-purple">│  │  ├── _chat_via_sdk()              → Anthropic SDK streaming               │  │</span>
<span class="highlight-purple">│  │  ├── _chat_via_http()             → OpenAI-compatible HTTP streaming      │  │</span>
<span class="highlight-purple">│  │  └── _chat_via_google()           → Google/Gemini (placeholder)           │  │</span>
<span class="highlight-purple">│  └───────────────────────────────────────────────────────────────────────────┘  │</span>
<span class="highlight-purple">│                                                                                  │</span>
<span class="highlight-purple">│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐                  │</span>
<span class="highlight-purple">│  │ ai.conversation │  │ ai.message      │  │ ai.access.gate  │                  │</span>
<span class="highlight-purple">│  │ (Chat history)  │  │ (Messages)      │  │ (Permissions)   │                  │</span>
<span class="highlight-purple">│  └─────────────────┘  └─────────────────┘  └─────────────────┘                  │</span>
<span class="highlight-purple">│                                                                                  │</span>
<span class="highlight-purple">│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐                  │</span>
<span class="highlight-purple">│  │ api.credentials │  │ api.service.    │  │ ai.token.usage  │                  │</span>
<span class="highlight-purple">│  │ (API keys)      │  │ provider        │  │ (Cost tracking) │                  │</span>
<span class="highlight-purple">│  └─────────────────┘  └─────────────────┘  └─────────────────┘                  │</span>
<span class="highlight-purple">└─────────────────────────────────────────────────────────────────────────────────┘</span>
              │
              ▼
<span class="highlight-orange">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-orange">│                             EXTERNAL AI PROVIDERS                                │</span>
<span class="highlight-orange">│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐                  │</span>
<span class="highlight-orange">│  │  Anthropic      │  │  OpenAI         │  │  Groq           │                  │</span>
<span class="highlight-orange">│  │  (via SDK)      │  │  (via HTTP)     │  │  (via HTTP)     │                  │</span>
<span class="highlight-orange">│  │  $$$            │  │  $$             │  │  $              │                  │</span>
<span class="highlight-orange">│  └─────────────────┘  └─────────────────┘  └─────────────────┘                  │</span>
<span class="highlight-orange">│                                                                                  │</span>
<span class="highlight-orange">│  ┌─────────────────┐  ┌─────────────────┐                                       │</span>
<span class="highlight-orange">│  │  Ollama         │  │  Google/Gemini  │                                       │</span>
<span class="highlight-orange">│  │  (LOCAL/FREE)   │  │  (placeholder)  │                                       │</span>
<span class="highlight-orange">│  └─────────────────┘  └─────────────────┘                                       │</span>
<span class="highlight-orange">└─────────────────────────────────────────────────────────────────────────────────┘</span>
                </div>
            </div>
            ...
            <div class="flow-diagram">
                ...
                <div class="ascii-diagram">
<span class="highlight-cyan">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-cyan">│                         SAM'S VALUE (Your IP)                                    │</span>
<span class="highlight-cyan">│  ┌─────────────────────────────────────────────────────────────────────────┐    │</span>
<span class="highlight-cyan">│  │  Business Intelligence    │  Odoo Integration    │  Memory System       │    │</span>
<span class="highlight-cyan">│  │  Workflow Automation      │  Power Prompts       │  Access Control      │    │</span>
<span class="highlight-cyan">│  │  Context Building         │  User Profiles       │  Cost Optimization   │    │</span>
<span class="highlight-cyan">│  └─────────────────────────────────────────────────────────────────────────┘    │</span>
<span class="highlight-cyan">│                                                                                  │</span>
<span class="highlight-cyan">│  SAM's characteristics, behavior, and intelligence are CONSISTENT               │</span>
<span class="highlight-cyan">│  regardless of which AI provider is the "language engine"                       │</span>
<span class="highlight-cyan">└─────────────────────────────────────────────────────────────────────────────────┘</span>

<span class="highlight-orange">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-orange">│                      LANGUAGE ENGINE (Replaceable)                               │</span>
<span class="highlight-orange">│                                                                                  │</span>
<span class="highlight-orange">│   Anthropic ($$$)  ←→  OpenAI ($$)  ←→  Groq ($)  ←→  Ollama (FREE)             │</span>
<span class="highlight-orange">│                                                                                  │</span>
<span class="highlight-orange">│   All provide "conversational ability" - SAM provides the INTELLIGENCE          │</span>
<span class="highlight-orange">└─────────────────────────────────────────────────────────────────────────────────┘</span>
                </div>
            </div>
        </div>
                ...
                <div class="flow-steps">
                    <div class="flow-step">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-file">ai_sam/static/src/components/sam_chat/sam_chat.js → sendMessage()</div>
                        </div>
                    ...
                    <div class="flow-step">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-file">ai_sam_base/controllers/sam_ai_chat_controller.py → send_message_streaming()</div>
                        </div>
                        <div class="step-arrow">↓</div>
                    </div>
                    <div class="flow-step">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-file">ai_sam_base/services/chat_input.py → gather_context()</div>
                        </div>
                        <div class="step-arrow">↓</div>
                    </div>
                    <div class="flow-step">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-file">ai_sam_base/models/ai_access_gate.py → check_access()</div>
                        </div>
                        <div class="step-arrow">↓</div>
                    </div>
                    <div class="flow-step">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-file">ai_sam_base/models/ai_brain.py → send_message_streaming()</div>
                        </div>
                        <div class="step-arrow">↓</div>
                    </div>
                    <div class="flow-step">
                    ...
                    <div class="flow-step">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-file">event: chunk → Frontend appends to response bubble</div>
                        </div>
                        <div class="step-arrow">↓</div>
                    </div>
                    <div class="flow-step">
...
<span class="highlight-pink">┌────────────────────────────────────────┐</span>
<span class="highlight-pink">│      FRONTEND (ai_sam module)          │</span>
<span class="highlight-pink">│                                        │</span>
<span class="highlight-pink">│  sam_chat_vanilla_v2.js                │</span>
<span class="highlight-pink">│  ├── User types message                │</span>
<span class="highlight-pink">│  ├── handleSend() → fetch()            │</span>
<span class="highlight-pink">│  └── Renders streaming response        │</span>
<span class="highlight-pink">└───────────────────┬────────────────────┘</span>
                    │
                    ▼
<span class="highlight-blue">┌────────────────────────────────────────┐</span>
<span class="highlight-blue">│      CONTROLLER (ai_sam_base)          │</span>
<span class="highlight-blue">│                                        │</span>
<span class="highlight-blue">│  sam_ai_chat_controller.py             │</span>
<span class="highlight-blue">│  └── unified_stream()                  │</span>
<span class="highlight-blue">└───────────────────┬────────────────────┘</span>
                    │
                    ▼
<span class="highlight-green">┌────────────────────────────────────────┐</span>
<span class="highlight-green">│         THE THREE LAYERS               │</span>
<span class="highlight-green">│                                        │</span>
<span class="highlight-green">│ ┌────────────────────────────────────┐ │</span>
<span class="highlight-green">│ │ <span class="highlight-cyan">1️⃣ chat_input.py</span>                  │ │</span>
<span class="highlight-green">│ │  BUILDS CONTEXT                    │ │</span>
<span class="highlight-green">│ │  ✓ gather_context()                │ │</span>
<span class="highlight-green">│ │  ✓ build_system_prompt()           │ │</span>
<span class="highlight-green">│ └────────────────────────────────────┘ │</span>
<span class="highlight-green">│                  │                     │</span>
<span class="highlight-green">│                  ▼                     │</span>
<span class="highlight-green">│ ┌────────────────────────────────────┐ │</span>
<span class="highlight-green">│ │ <span class="highlight-purple">2️⃣ ai_brain.py</span> (orchestrator)     │ │</span>
<span class="highlight-green">│ │  COORDINATES AI CALL               │ │</span>
<span class="highlight-green">│ │  ✓ send_message_streaming()        │ │</span>
<span class="highlight-green">│ │  ✓ Handles tool use                │ │</span>
<span class="highlight-green">│ └────────────────────────────────────┘ │</span>
<span class="highlight-green">│                  │                     │</span>
<span class="highlight-green">│                  ▼                     │</span>
<span class="highlight-green">│ ┌────────────────────────────────────┐ │</span>
<span class="highlight-green">│ │ <span class="highlight-yellow">3️⃣ sam_voice.py</span> (kernel)          │ │</span>
<span class="highlight-green">│ │  DEFINES HOW SAM THINKS            │ │</span>
<span class="highlight-green">│ │  ✓ SAM_TOOLS_V1 definitions        │ │</span>
<span class="highlight-green">│ │  ✓ format_memory_context()         │ │</span>
<span class="highlight-green">│ └────────────────────────────────────┘ │</span>
<span class="highlight-green">└────────────────────────────────────────┘</span>
                    │
                    ▼
<span class="highlight-orange">┌────────────────────────────────────────┐</span>
<span class="highlight-orange">│         SUPPORTING FILES               │</span>
<span class="highlight-orange">│                                        │</span>
<span class="highlight-orange">│  SAM_AI_PERSONALITY.md (~94 lines)     │</span>
<span class="highlight-orange">│  └── WHO SAM is (warm, adaptive)       │</span>
<span class="highlight-orange">└────────────────────────────────────────┘</span>
                    </div>
                </div>
                ...
                <div class="flow-diagram">
                    ...
                    <div class="ascii-diagram" style="font-size: 0.65rem;">
<span class="highlight-cyan">┌────────────────────────────────────────┐</span>
<span class="highlight-cyan">│      USER EXPERIENCE TIMELINE          │</span>
<span class="highlight-cyan">├────────────────────────────────────────┤</span>
<span class="highlight-cyan">│                                        │</span>
<span class="highlight-cyan">│  User clicks Send                      │</span>
<span class="highlight-cyan">│       │                                │</span>
<span class="highlight-cyan">│       ▼                                │</span>
<span class="highlight-cyan">│  ┌──────────────────────────────────┐  │</span>
<span class="highlight-cyan">│  │ <span class="highlight-green">chat_input.py: gather_context()</span> │  │</span>
<span class="highlight-cyan">│  │ ├── 🔐 Checking access...       │  │</span>
<span class="highlight-cyan">│  │ ├── 📂 Reading folder...        │  │</span>
<span class="highlight-cyan">│  │ ├── 📄 Found 15 files...        │  │</span>
<span class="highlight-cyan">│  │ ├── 🧠 Searching memories...    │  │</span>
<span class="highlight-cyan">│  │ └── 🔧 Building context...      │  │</span>
<span class="highlight-cyan">│  └──────────────────────────────────┘  │</span>
<span class="highlight-cyan">│       │                                │</span>
<span class="highlight-cyan">│       ▼                                │</span>
<span class="highlight-cyan">│  ┌──────────────────────────────────┐  │</span>
<span class="highlight-cyan">│  │ <span class="highlight-purple">ai_brain.py: streaming()</span>        │  │</span>
<span class="highlight-cyan">│  │ ├── <span class="highlight-yellow">✨ Thinking...</span> (varied)    │  │</span>
<span class="highlight-cyan">│  │ ├── <span class="highlight-yellow">✨ Composing response...</span>   │  │</span>
<span class="highlight-cyan">│  │ └── 💬 Responding...            │  │</span>
<span class="highlight-cyan">│  └──────────────────────────────────┘  │</span>
<span class="highlight-cyan">│       │                                │</span>
<span class="highlight-cyan">│       ▼                                │</span>
<span class="highlight-cyan">│  ┌──────────────────────────────────┐  │</span>
<span class="highlight-cyan">│  │ <span class="highlight-orange">chat_output.py: format()</span>        │  │</span>
<span class="highlight-cyan">│  │ ├── Formats for SSE             │  │</span>
<span class="highlight-cyan">│  │ ├── Streams chunks              │  │</span>
<span class="highlight-cyan">│  │ └── <span class="highlight-green">✅ Done</span>                    │  │</span>
<span class="highlight-cyan">│  └──────────────────────────────────┘  │</span>
<span class="highlight-cyan">│                                        │</span>
<span class="highlight-cyan">└────────────────────────────────────────┘</span>

<span class="highlight-yellow">Activity messages defined in:</span>
<span class="highlight-orange">chat_output.py → ACTIVITY_MESSAGES</span>
                    </div>
                </div>
                ...
                <div class="flow-diagram">
                    ...
                    <div class="ascii-diagram" style="font-size: 0.65rem;">
<span class="highlight-purple">┌────────────────────────────────────────┐</span>
<span class="highlight-purple">│  User: "What's in D:\MyFolder?"        │</span>
<span class="highlight-purple">└───────────────────┬────────────────────┘</span>
                    │
                    ▼
<span class="highlight-blue">┌────────────────────────────────────────┐</span>
<span class="highlight-blue">│  AI receives tools from sam_voice.py   │</span>
<span class="highlight-blue">│  (read_file, list_directory, etc.)     │</span>
<span class="highlight-blue">└───────────────────┬────────────────────┘</span>
                    │
                    ▼
<span class="highlight-cyan">┌────────────────────────────────────────┐</span>
<span class="highlight-cyan">│  AI responds with tool_use:            │</span>
<span class="highlight-cyan">│  list_directory("D:\MyFolder")         │</span>
<span class="highlight-cyan">└───────────────────┬────────────────────┘</span>
                    │
                    ▼
<span class="highlight-yellow">┌────────────────────────────────────────┐</span>
<span class="highlight-yellow">│  _execute_tool() checks               │</span>
<span class="highlight-yellow">│  ai.access.gate for permission        │</span>
<span class="highlight-yellow">└───────────────────┬────────────────────┘</span>
                    │
        ┌───────────┴───────────┐
        │                       │
        ▼                       ▼
<span class="highlight-red">┌─────────────────┐</span>   <span class="highlight-green">┌─────────────────┐</span>
<span class="highlight-red">│ NO PERMISSION   │</span>   <span class="highlight-green">│ GRANTED         │</span>
<span class="highlight-red">│                 │</span>   <span class="highlight-green">│                 │</span>
<span class="highlight-red">│ yield           │</span>   <span class="highlight-green">│ Execute tool    │</span>
<span class="highlight-red">│ permission_     │</span>   <span class="highlight-green">│                 │</span>
<span class="highlight-red">│ required        │</span>   <span class="highlight-green">│       │         │</span>
<span class="highlight-red">└────────┬────────┘</span>   <span class="highlight-green">└───────┬─────────┘</span>
         │                     │
         ▼                     ▼
<span class="highlight-orange">┌─────────────────┐</span>   <span class="highlight-blue">┌─────────────────┐</span>
<span class="highlight-orange">│ Frontend shows  │</span>   <span class="highlight-blue">│ Tool result     │</span>
<span class="highlight-orange">│ permission      │</span>   <span class="highlight-blue">│ sent back to AI │</span>
<span class="highlight-orange">│ popup 🔐        │</span>   <span class="highlight-blue">│                 │</span>
<span class="highlight-orange">└────────┬────────┘</span>   <span class="highlight-blue">└───────┬─────────┘</span>
         │                     │
         ▼                     ▼
<span class="highlight-green">┌─────────────────┐</span>   <span class="highlight-green">┌─────────────────┐</span>
<span class="highlight-green">│ User grants     │</span>   <span class="highlight-green">│ AI responds     │</span>
<span class="highlight-green">│ permission      │</span>   <span class="highlight-green">│ with folder     │</span>
<span class="highlight-green">│ ✅ Allow        │</span>   <span class="highlight-green">│ contents        │</span>
<span class="highlight-green">└─────────────────┘</span>   <span class="highlight-green">└─────────────────┘</span>
                    </div>
                </div>
            </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><code>{"activity": "reading_folder", "message": "📂 Reading..."}</code></td>
                        </tr>
                        <tr>
...
<span class="highlight-purple">send_message_streaming()</span>
          │
          │ <span class="highlight-yellow">config.api_format</span>
          │
          ├──── <span class="highlight-blue">'anthropic'</span> ────► <span class="highlight-cyan">_chat_via_sdk()</span>
          │                          │
          │                          └── Uses Anthropic SDK
          │                              <span class="highlight-green">client.messages.stream()</span>
          │
          ├──── <span class="highlight-blue">'openai'</span> ──────► <span class="highlight-cyan">_chat_via_http()</span>
          │                          │
          │                          └── Raw HTTP SSE
          │                              Works with: OpenAI, Groq, Ollama,
          │                              Azure, DeepSeek, Together AI, etc.
          │
          └──── <span class="highlight-blue">'google'</span> ──────► <span class="highlight-cyan">_chat_via_google()</span>
                                     │
            ...
            <div class="component-grid">
                <div class="component-card">
                    <div class="component-header">
                        <div class="component-icon layer-service">🔌</div>
...
<span class="highlight-cyan">_chat_via_http(config, system_prompt, messages)</span>
    ...
    │       <span class="highlight-green">[{role: 'system', content: ...}, {role: 'user', ...}]</span>
    │
    ├── 2. Construct endpoint URL
    │       <span class="highlight-yellow">config.api_endpoint</span> + '/v1/chat/completions'
    │
    ├── 3. POST with stream=True
    │       <span class="highlight-orange">requests.post(url, headers, json=payload, stream=True)</span>
    │
    ├── 4. Parse SSE stream
    │       for line in response.iter_lines():
    │           if line.startswith('data: '):
    │               <span class="highlight-purple">data = json.loads(line[6:])</span>
    │               content = data['choices'][0]['delta'].get('content')
    │               <span class="highlight-green">yield {'type': 'chunk', 'data': {'text': content}}</span>
    │
    └── 5. Yield final metadata
        ...
        <div id="models" class="section">
            ...
            <div class="component-grid">
                <div class="component-card">
                    <div class="component-header">
                        <div class="component-icon layer-model">🧠</div>
        ...
        <div id="services" class="section">
            ...
            <div class="component-grid">
                ...
                <div class="component-card">
                    <div class="component-header">
                        <div class="component-icon layer-service">🗂️</div>
                ...
                <div class="component-card">
                    ...
                    <div class="method-list">
                        <div class="method-item">
                            ...
                            <span class="method-desc">De-branded activity phrases (✨ Thinking...)</span>
                        </div>
                    </div>
                </div>
...
<span class="highlight-cyan">gather_context(context_data, user_message)</span>
    │
    ├── <span class="highlight-yellow">WORKFLOW MODE CHECK</span>
    │   └── If workflow node context → yield workflow_mode → return
    │
    ├── <span class="highlight-green">PHASE 1: ACCESS GATE + FOLDER READING</span>
    │   ├── yield <span class="highlight-blue">'checking_access'</span> → 🔐 Checking access...
    │   ├── ai.access.gate.check_access(path)
    │   │   ├── needs_approval? → yield <span class="highlight-orange">'permission_required'</span> → STOP
    │   │   └── denied? → yield <span class="highlight-orange">'access_denied'</span> → STOP
    │   ├── yield <span class="highlight-blue">'reading_folder'</span> → 📂 Reading folder...
    │   └── NodeInput.extract_folder_context()
    │       └── yield <span class="highlight-blue">'counting_files'</span> → 📄 Found N files...
    │
    ├── <span class="highlight-green">PHASE 2: MEMORY SEARCH</span>
    │   └── yield <span class="highlight-blue">'searching_memory'</span> → 🧠 Searching past conversations...
    │
    ├── <span class="highlight-green">PHASE 3: CONTEXT BUILDING</span>
    │   └── yield <span class="highlight-blue">'building_context'</span> → 🔧 Building context...
    │
    └── <span class="highlight-purple">FINAL: yield 'context_complete' with full context dict</span>
                </div>
            </div>
        </div>
...
<span class="highlight-cyan">node_metadata.json</span> (Source of truth for vendors)
    │
    │  <span class="highlight-yellow">"groq": {</span>
    │  <span class="highlight-yellow">  "displayName": "Groq",</span>
    │  <span class="highlight-yellow">  "api_format": "openai",</span>
    │  <span class="highlight-yellow">  "api_endpoint": "https://api.groq.com/openai",</span>
    │  <span class="highlight-yellow">  "default_model": "llama-3.1-70b-versatile"</span>
    │  <span class="highlight-yellow">}</span>
    │
    ▼
<span class="highlight-green">vendor_registry_controller.py</span>
    │
    │  _populate_vendor_credentials()
    │  └── Reads api_format, api_endpoint, default_model from metadata
    │
    ▼
<span class="highlight-purple">api.service.provider</span> (Database records)
    │
    │  Created with correct api_format for routing
    │
    ▼
<span class="highlight-blue">ai_brain.py</span>
    │
    │  send_message_streaming()
    │  └── Routes based on config.api_format
    │      ├── 'openai' → _chat_via_http()
    │      └── 'anthropic' → _chat_via_sdk()
                </div>
            </div>
...
<span class="highlight-purple">Anthropic (Claude)</span>    ████████████████████████████████████████  $15-75
<span class="highlight-blue">OpenAI (GPT-4)</span>        ██████████████████████████████            $10-30
<span class="highlight-green">Groq (Llama)</span>          █                                         $0.05-0.27
...
├── Development/Testing:  <span class="highlight-green">Groq</span> (nearly free, very fast)
├── Privacy-sensitive:    <span class="highlight-cyan">Ollama</span> (100% local, your hardware)
├── Enterprise customers: <span class="highlight-blue">Let THEM choose</span> (their API key)
└── Maximum quality:      <span class="highlight-purple">Anthropic/OpenAI</span> (customer pays)
                </div>
            </div>
        </div>
        ...
        <div id="ml-layer" class="section">
            <div class="flow-diagram">
                ...
                <div class="ascii-diagram">
<span class="highlight-cyan">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-cyan">│                         ML LAYER (Optional - Graceful Degradation)               │</span>
<span class="highlight-cyan">│                                                                                  │</span>
<span class="highlight-cyan">│   SAM works perfectly WITHOUT this layer - it just enables personalization       │</span>
<span class="highlight-cyan">│                                                                                  │</span>
<span class="highlight-cyan">│  ┌─────────────────────────────────────────────────────────────────────────┐    │</span>
<span class="highlight-cyan">│  │                        SCIKIT-LEARN (Optional)                          │    │</span>
<span class="highlight-cyan">│  │                                                                         │    │</span>
<span class="highlight-cyan">│  │  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐         │    │</span>
<span class="highlight-cyan">│  │  │  TF-IDF         │  │  KMeans         │  │  Classification │         │    │</span>
<span class="highlight-cyan">│  │  │  Vectorizer     │  │  Clustering     │  │  (Style)        │         │    │</span>
<span class="highlight-cyan">│  │  │                 │  │                 │  │                 │         │    │</span>
<span class="highlight-cyan">│  │  │ Text → Numbers  │  │ Group by Topic  │  │ Detect Patterns │         │    │</span>
<span class="highlight-cyan">│  │  └────────┬────────┘  └────────┬────────┘  └────────┬────────┘         │    │</span>
<span class="highlight-cyan">│  │           │                    │                    │                   │    │</span>
<span class="highlight-cyan">│  │           └────────────────────┼────────────────────┘                   │    │</span>
<span class="highlight-cyan">│  │                                │                                        │    │</span>
<span class="highlight-cyan">│  │                                ▼                                        │    │</span>
<span class="highlight-cyan">│  │           ┌─────────────────────────────────────────┐                   │    │</span>
<span class="highlight-cyan">│  │           │        ML INSIGHTS (if available)       │                   │    │</span>
<span class="highlight-cyan">│  │           │                                         │                   │    │</span>
<span class="highlight-cyan">│  │           │  • User prefers bullet points           │                   │    │</span>
<span class="highlight-cyan">│  │           │  • Technical vocabulary detected        │                   │    │</span>
<span class="highlight-cyan">│  │           │  • Recurring topic: "sales automation"  │                   │    │</span>
<span class="highlight-cyan">│  │           │  • Communication style: concise         │                   │    │</span>
<span class="highlight-cyan">│  │           └─────────────────────┬───────────────────┘                   │    │</span>
<span class="highlight-cyan">│  │                                 │                                       │    │</span>
<span class="highlight-cyan">│  └─────────────────────────────────┼───────────────────────────────────────┘    │</span>
<span class="highlight-cyan">│                                    │                                            │</span>
<span class="highlight-cyan">│                                    ▼                                            │</span>
<span class="highlight-cyan">│  ┌─────────────────────────────────────────────────────────────────────────┐    │</span>
<span class="highlight-cyan">│  │                     sam_voice.py (THE GUARDRAIL)                         │    │</span>
<span class="highlight-cyan">│  │                                                                         │    │</span>
<span class="highlight-cyan">│  │  <span class="highlight-green">✓ ALLOWED:</span>                                                            │    │</span>
<span class="highlight-cyan">│  │    • Silent adaptation (just DO it, don't announce)                    │    │</span>
<span class="highlight-cyan">│  │    • Match communication style                                         │    │</span>
<span class="highlight-cyan">│  │    • Provide deeper context on recurring topics                        │    │</span>
<span class="highlight-cyan">│  │                                                                         │    │</span>
<span class="highlight-cyan">│  │  <span class="highlight-red">✗ FORBIDDEN (CREEPY):</span>                                                  │    │</span>
<span class="highlight-cyan">│  │    • "I noticed you work late on Thursdays..."                         │    │</span>
<span class="highlight-cyan">│  │    • "Based on your emotional patterns..."                             │    │</span>
<span class="highlight-cyan">│  │    • "Your productivity seems lower today..."                          │    │</span>
<span class="highlight-cyan">│  │    • "I've been tracking your response times..."                       │    │</span>
<span class="highlight-cyan">│  └─────────────────────────────────┬───────────────────────────────────────┘    │</span>
<span class="highlight-cyan">│                                    │                                            │</span>
<span class="highlight-cyan">│                                    ▼                                            │</span>
<span class="highlight-cyan">│                          ai_brain.py (THE BRAIN)                                │</span>
<span class="highlight-cyan">│                          ML insights filtered through sam_voice                 │</span>
<span class="highlight-cyan">└─────────────────────────────────────────────────────────────────────────────────┘</span>
                </div>
            </div>
            ...
            <div class="flow-diagram">
                ...
                <div class="ascii-diagram">
<span class="highlight-yellow">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-yellow">│                          GRACEFUL DEGRADATION                                    │</span>
<span class="highlight-yellow">│                                                                                  │</span>
<span class="highlight-yellow">│   <span class="highlight-green">WITH ML (scikit-learn installed):</span>                                             │</span>
<span class="highlight-yellow">│   ├── Topic clustering works                                                    │</span>
<span class="highlight-yellow">│   ├── Style detection works                                                     │</span>
<span class="highlight-yellow">│   ├── Response optimization works                                               │</span>
<span class="highlight-yellow">│   └── SAM becomes more personalized over time                                   │</span>
<span class="highlight-yellow">│                                                                                  │</span>
<span class="highlight-yellow">│   <span class="highlight-blue">WITHOUT ML (scikit-learn NOT installed):</span>                                       │</span>
<span class="highlight-yellow">│   ├── All core features work normally                                           │</span>
<span class="highlight-yellow">│   ├── Chat works                                                                │</span>
<span class="highlight-yellow">│   ├── Streaming works                                                           │</span>
<span class="highlight-yellow">│   ├── Memory works (if chromadb installed)                                      │</span>
<span class="highlight-yellow">│   └── SAM just doesn't learn patterns                                           │</span>
<span class="highlight-yellow">│                                                                                  │</span>
<span class="highlight-yellow">│   <span class="highlight-purple">Code Pattern:</span>                                                                  │</span>
<span class="highlight-yellow">│   ┌─────────────────────────────────────────────────────────────────────────┐   │</span>
<span class="highlight-yellow">│   │  try:                                                                   │   │</span>
<span class="highlight-yellow">│   │      from sklearn.feature_extraction.text import TfidfVectorizer       │   │</span>
<span class="highlight-yellow">│   │      from sklearn.cluster import KMeans                                │   │</span>
<span class="highlight-yellow">│   │      <span class="highlight-green">ML_AVAILABLE = True</span>                                                 │   │</span>
<span class="highlight-yellow">│   │  except ImportError:                                                   │   │</span>
<span class="highlight-yellow">│   │      <span class="highlight-orange">ML_AVAILABLE = False</span>                                                │   │</span>
<span class="highlight-yellow">│   │      _logger.info("ML features disabled - SAM works normally")         │   │</span>
<span class="highlight-yellow">│   └─────────────────────────────────────────────────────────────────────────┘   │</span>
<span class="highlight-yellow">└─────────────────────────────────────────────────────────────────────────────────┘</span>
                </div>
            </div>
            ...
            <div class="flow-diagram">
                ...
                <div class="ascii-diagram">
<span class="highlight-green">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-green">│                           HELPFUL (Do This)                                      │</span>
<span class="highlight-green">│                                                                                  │</span>
<span class="highlight-green">│  User asks about "sales pipelines" frequently                                   │</span>
<span class="highlight-green">│  └─► SAM provides more depth on sales topics without being asked                │</span>
<span class="highlight-green">│                                                                                  │</span>
<span class="highlight-green">│  User prefers bullet points                                                     │</span>
<span class="highlight-green">│  └─► SAM uses bullet points more often (silently adapts)                        │</span>
<span class="highlight-green">│                                                                                  │</span>
<span class="highlight-green">│  User is technical                                                              │</span>
<span class="highlight-green">│  └─► SAM skips basic explanations (without saying "I know you're technical")    │</span>
<span class="highlight-green">└─────────────────────────────────────────────────────────────────────────────────┘</span>

<span class="highlight-red">┌─────────────────────────────────────────────────────────────────────────────────┐</span>
<span class="highlight-red">│                           CREEPY (Never Do This)                                 │</span>
<span class="highlight-red">│                                                                                  │</span>
<span class="highlight-red">│  ✗ "I noticed you always work late on Thursdays..."                             │</span>
<span class="highlight-red">│  ✗ "Based on your emotional patterns, you seem stressed today..."               │</span>
<span class="highlight-red">│  ✗ "Your productivity seems lower than usual..."                                │</span>
<span class="highlight-red">│  ✗ "I've been tracking your response times and..."                              │</span>
<span class="highlight-red">│  ✗ "You've asked about [topic] 47 times this month..."                          │</span>
<span class="highlight-red">│  ✗ "I've observed that you..."                                                  │</span>
<span class="highlight-red">└─────────────────────────────────────────────────────────────────────────────────┘</span>
