...
def main_add(subdomain, custom_domain, ssl_flag, module_path):
    _logger.info('-'*10, subdomain, custom_domain, ssl_flag, module_path, '-'*10)
    odoo_saas_data = read_path_saas_conf(module_path)
    try:
...
if __name__ == '__main__':
    ...
    main_add(subdomain=subdomain, custom_domain=custom_domain, ssl_flag=True, module_path="/opt/odoo14/webkul_addons/sme_saas_base/")
