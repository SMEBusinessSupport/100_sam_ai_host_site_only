    ...
    def action_create_contract(self):
        for obj in self:
            ...
            try:
                ...
                action = imd.xmlid_to_object('sme_saas_base.saas_contract_action')
                list_view_id = imd.xmlid_to_res_id('sme_saas_base.saas_contract_tree_view')
                form_view_id = imd.xmlid_to_res_id('sme_saas_base.saas_contract_form_view')
